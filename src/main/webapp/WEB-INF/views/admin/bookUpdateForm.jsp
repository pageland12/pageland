...
<body>
	<form name="bookWriteForm" method="post" action="/admin/bookUpdate">
	<input type="hidden" name="bno" value="${update.bno}">
	    <table>
	        ...
	        <tr>
	            <td>책 이미지</td>
	            <%-- <td><input type="file" name="bimgpic" accept="image/*"></td> --%>
	            <td><input type="text" name="bimg" value="${update.bimg}" placeholder="도서 이미지 URL"></td>
	        </tr>
	        <tr>
	            <td>세부 정보</td>
	            <%-- <td><input type="file" name="binfopic" accept="image/*"></td> --%>
