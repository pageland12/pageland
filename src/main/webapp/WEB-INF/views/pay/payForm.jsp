...
<body>
    ...
    <div>
        <p>주문 상품: ${prodName} 외 ${prodCount}건</span></p>
        <p>배송비: ${fee}원</p>
        ...
        async function requestPayment() {
            ...
            try {
                ...
                const response = await PortOne.requestPayment({
                    storeId: "store-30399cea-2dc5-47b1-8daa-39beeea2337e",          // 발급받으신 Store ID 작성
                    channelKey: "channel-key-374933b0-f383-45d1-aecd-b9327f3acb38",  // 저장하신 Channel Key 작성
                    paymentId: paymentId,
                    orderName: orderName,
